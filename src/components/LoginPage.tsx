                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between px-1">
                                ...
                                <a href="#" className="text-[11px] font-bold text-accent hover:text-accent/80 transition-colors uppercase tracking-wider">Forgot?</a>
                            </div>
                            <div className="relative group">
                    ...
                    <div className="text-center pt-2">
                        <p className="text-sm text-slate-500 font-medium">
                            Don't have an account? <a href="#" className="text-accent hover:text-accent/80 transition-colors font-bold">Contact support</a>
                        </p>
                    </div>
                </form>
            </motion.div>
